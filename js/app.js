...
app.factory('transitions', [function(){
    var o = {
        gif: [
            {url: 'http://i.giphy.com/slrRZ7bkPy6oU.gif', playerStatus: "NOT PLAYING"},
            {url: 'http://i.giphy.com/pwE3XEUZdAJSE.gif', playerStatus: "NOT PLAYING"},
            {url: 'http://i.giphy.com/od22gJJ5IdwFq.gif', playerStatus: "NOT PLAYING"},
            {url: 'http://i.giphy.com/FhXFXgOjLnAS4.gif', playerStatus: "NOT PLAYING"},
            {url: 'http://i.giphy.com/twIv2W4ZZxvP2.gif', playerStatus: "NOT PLAYING"},
            {url: 'http://i.giphy.com/W62Cg8rUyhRwk.gif', playerStatus: "NOT PLAYING"},
            {url: 'http://i.giphy.com/yugSj8GSC0wXm.gif', playerStatus: "NOT PLAYING"},
            {url: 'http://i.giphy.com/q9qcnr2bxEWM8.gif', playerStatus: "NOT PLAYING"},
            {url: 'http://i.giphy.com/KHF6bCDkreXeM.gif', playerStatus: "NOT PLAYING"},
